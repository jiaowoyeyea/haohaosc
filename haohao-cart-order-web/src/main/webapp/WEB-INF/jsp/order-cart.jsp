		...
		<div class="orderItem">
			...
			<div class="orderTbl">
				...
				<div class="orderPInfo">
					<div class="pItem">
						<a href="http://localhost:8086/item/${cart.itemId}.html" target="_blank">
						<img src="${cart.images[0] }" style="width: 60px;height: 60px;"/>
						</a>
					</div>
					<div class="pItem pGoods">
						<a href="http://localhost:8086/item/${cart.itemId}.html" target="_blank">${cart.itemTitle }</a>
					</div>
					<div class="pItem pPrice" style="position: relative; z-index: 99">
						¥<fmt:formatNumber
							groupingUsed="false" maxFractionDigits="2"
							minFractionDigits="2" value="${cart.itemPrice / 100 }" />
					</div>
					...
					<div class="pItem pSubtotal">¥${cart.itemPrice / 100 * cart.num}</div> 
					<span class="clear"></span>
				</div>
				</c:forEach>
