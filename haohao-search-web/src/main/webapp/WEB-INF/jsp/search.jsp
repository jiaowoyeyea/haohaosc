    ...
    <div class="r-filter">
      <div class="f-sort">
        <div class="pagin">
         ...
         <a href="/search.html?keyword=${query}&page=${page==1?1:page-1}">&lt;&lt;上一页</a> <!-- <span class="prev"></span> -->
         &nbsp;&nbsp; <a href="/search.html?keyword=${query}&page=${page==totalPages?totalPages:page+1}">下一页&gt;&gt;</a><!-- <span class="next"></span>  --> 
