...
<div class="cartMain">
	...
	<div class="cartMain">
				...
				<div class="cartPInfo" id="danjian-0-229363">
					<div class="clearit">
						...
						<div class="pItem pGoods">
							<div class="cart_pimg">
								<a target="_blank" title="${cart.itemTitle }" href="http://localhost:8086/item/${cart.id }.html">
								<img src="${cart.images[0] }" style="width: 60px;height: 60px;"/>
								</a>
							</div>
							<div class="cart_pname">
								<div>
								<a target="_blank" href="http://localhost:8086/item/${cart.id }.html">${cart.itemTitle }</a>
								</div>
						...
						<div class="pItem pPrice">
							<div style="position: relative;">
								<strong>¥<fmt:formatNumber groupingUsed="false" value="${cart.itemPrice / 100}" maxFractionDigits="2" minFractionDigits="2"/></strong>
							</div>
						</div>
						...
						<div class="pItem pQuantity">
							<div class="cartAmount">
								...
								<input type="text" value="${cart.num }" class="amount itemnum" itemPrice="${cart.itemPrice}" itemId="${cart.id}" id="amountdanjian-0-229363" name="amount">
								<a href="javascript:void(0);" class="cartCountBtn increment">+</a> 
							</div>
						</div>
						<div class="pItem pWeight">0.05kg<br></div>
						<div class="pItem pSubtotal">
							<span id="total_price" class="totalprice">¥<fmt:formatNumber groupingUsed="false" value="${cart.itemPrice / 100 * cart.num}" maxFractionDigits="2" minFractionDigits="2"/></span>
						</div>
      ...
      <div class="cartJsuan">
         ...
         <input onclick="javascript:document.location.href='http://localhost:8010/order/order-cart.html'" class="jiesuan youxuan" value="去结算" type="button">
      </div>
    </div>
</div>
<!-- footer start -->
